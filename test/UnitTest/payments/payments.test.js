...
import { addPayment, addPaymentAll, getUserPayments } from '../../../src/payment/controller.js'
...
describe ('POST /payments/all', () => {
  ...
  beforeAll (async () => {
    ...
    jest.spyOn(instance, 'transaction').mockImplementation(() => {
      ...
      payment.payment_amount = user1.balance
      const result = {
        'payment_id': 1,
        'payment_amount': payment.payment_amount,
        'payment_dtm': '2012-03-19T07:22Z',
